...
protected:
                  ...
                  std::integral_constant<size_t, I>)
  {
    ...
    if (!_column_format.empty())
    {
      // Because "stream << std::defaultfloat;" won't compile with old GCC or
      // Clang
  ...
  /**
   * These three functions iterate over the Tuple, find the printed size of each
   * element and set it in a vector
   */
